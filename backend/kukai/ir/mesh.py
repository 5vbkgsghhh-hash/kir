...
# M006, А НЕ M001 (10.08.2026): `KIR-M001` носил ДВА имени в двух
# подсистемах — `macros.MACRO_ERROR` (раскрытие макроса) и это. Съехал меш, а
# не макрос: макросная сторона стоит в тестах ПЯТНАДЦАТЬЮ литералами, а эта —
# одной константой, поэтому перенос сюда стоит одну строку вместо пятнадцати.
# На `M001` не ветвится ни один потребитель в проде.
