...
using (Transaction __t = new Transaction(doc, "KIR: полный набор аннотаций: размер+марка+текст"))
{
    try
    {
        ...
        try { Parameter __cm = __el_W1.get_Parameter(BuiltInParameter.ALL_MODEL_INSTANCE_COMMENTS); if (__cm != null && !__cm.IsReadOnly) __cm.Set("kir:fac5ef60:W1"); } catch { }
        ...
        try { Parameter __cm = __el_D1.get_Parameter(BuiltInParameter.ALL_MODEL_INSTANCE_COMMENTS); if (__cm != null && !__cm.IsReadOnly) __cm.Set("kir:fac5ef60:D1"); } catch { }
        ...
        try { Parameter __cm = __el_T1.get_Parameter(BuiltInParameter.ALL_MODEL_INSTANCE_COMMENTS); if (__cm != null && !__cm.IsReadOnly) __cm.Set("kir:fac5ef60:T1"); } catch { }
        ...
        try { Parameter __cm = __el_X1.get_Parameter(BuiltInParameter.ALL_MODEL_INSTANCE_COMMENTS); if (__cm != null && !__cm.IsReadOnly) __cm.Set("kir:fac5ef60:X1"); } catch { }
