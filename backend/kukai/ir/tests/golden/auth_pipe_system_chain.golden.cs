...
using (Transaction __t = new Transaction(doc, "KIR: стояк ВК с отводом"))
{
    try
    {
        ...
        // create_pipe_system SYS1 — graph: 3 nodes, 2 segments
        ...
        __seg_SYS1_0 = Autodesk.Revit.DB.Plumbing.Pipe.Create(doc, new ElementId(300), new ElementId(200), __lv_SYS1.Id, P(0.0, 0.0, 0.0), P(0.0, 0.0, 15000.0));
        ...
        __seg_SYS1_1 = Autodesk.Revit.DB.Plumbing.Pipe.Create(doc, new ElementId(300), new ElementId(200), __lv_SYS1.Id, P(0.0, 0.0, 15000.0), P(3000.0, 0.0, 15000.0));
        ...
        var __cn_0_0 = __nearestFree(__seg_SYS1_0, P(0.0, 0.0, 15000.0));
        var __cn_0_1 = __nearestFree(__seg_SYS1_1, P(0.0, 0.0, 15000.0));
        ...
        try { Parameter __cm = __seg_SYS1_0.get_Parameter(BuiltInParameter.ALL_MODEL_INSTANCE_COMMENTS); if (__cm != null && !__cm.IsReadOnly) __cm.Set("kir:86ed52b9:SYS1:0"); } catch { }
        try { Parameter __cm = __seg_SYS1_1.get_Parameter(BuiltInParameter.ALL_MODEL_INSTANCE_COMMENTS); if (__cm != null && !__cm.IsReadOnly) __cm.Set("kir:86ed52b9:SYS1:1"); } catch { }
        ...
        // post SYS1
            { var __lc = __seg_SYS1_0.Location as LocationCurve; if (__lc == null) __post.Add("SYS1: segment 0 no curve (geometry)");
                ...
                double __r1z = MM(__e1.Z)-(15000.0);
