...
| Опубликованный backend-срез | **797 файлов кода и конфигурации** | commit `23dd666`, 2026-08-03 |
| Проверка синтаксиса Python при публикации | **764 файла разобрано** | Python 3.12, 2026-08-03 |
