...
class GridAnchors(unittest.TestCase):
    ...
    # KIR-G105 WAS RETIRED ON 04.08.2026 (RELATE): one code for three
    # different fixes could not name the next move in any of them. What is
    # checked here is that CONTOUR received split codes, not that it
    # received them "somewhere" — each case is named separately.
