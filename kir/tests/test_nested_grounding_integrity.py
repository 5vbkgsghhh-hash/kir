...
from kir import compiler as compiler_module
from kir.acceptance_evidence import AcceptanceEvidenceError, AcceptanceRegistration
from kir.compiler import compile_program, plan_program
from kir.ground import ground as legacy_ground
...
def test_nested_contract_change_changes_parent_plan_digest():
    ...
    with mock.patch(
            "kir.compiler.contract_for", side_effect=changed_contract):
...
def test_buggy_grounder_cannot_change_semantics_or_add_private_fields(mutation):
    ...
    with mock.patch("kir.ground.ground", side_effect=corrupted):
