...
double __dtq_D1 = 0.0;
double[] __bva_D1 = new double[1];
double[] __bvb_D1 = new double[1];
double[] __bvi_D1 = new double[1];
double[] __bvr_D1 = new double[1];
double[] __bvx_D1 = new double[1];
double[] __bdl_D1 = new double[1];
using (Transaction __t = new Transaction(doc, "KIR: куб минус сфера"))
{
    try
    {
        ...
        // create_solid_boolean D1 — difference: база 4 рёбер x 4000 мм, части: sphere
        ...
        // шаг 0: Difference с частью sphere
        CurveLoop __plp_D1_0 = new CurveLoop();
        IList<CurveLoop> __pls_D1_0 = new List<CurveLoop>();
        XYZ __pc_D1_0 = P(2000.0, 2000.0, 4000.0);
        __plp_D1_0.Append(Arc.Create(__pc_D1_0, U(2400.0), -0.5 * Math.PI, 0.5 * Math.PI, XYZ.BasisX, XYZ.BasisZ));
        __plp_D1_0.Append(Line.CreateBound(P(2000.0, 2000.0, 6400.0), P(2000.0, 2000.0, 1600.0)));
        __pls_D1_0.Add(__plp_D1_0);
        Frame __pfr_D1_0 = new Frame(__pc_D1_0, XYZ.BasisX, XYZ.BasisY, XYZ.BasisZ);
        Solid __prt_D1_0 = GeometryCreationUtilities.CreateRevolvedGeometry(__pfr_D1_0, __pls_D1_0, 0.0, 2.0 * Math.PI);
        if (__prt_D1_0 == null || __prt_D1_0.Faces.Size == 0) { __t.RollBack(); return __Refuse("D1", "часть 0 (sphere) не построилась: Revit вернул пустое тело"); }
        ...
        try { Parameter __cm = __el_D1.get_Parameter(BuiltInParameter.ALL_MODEL_INSTANCE_COMMENTS); if (__cm != null && !__cm.IsReadOnly) __cm.Set("kir:4de54cee:D1"); } catch { }
...
// witness D1
{
    ...
    __rb["step0_shape"] = "sphere";
    __rb["step0_part_bbox_mm"] = "-400.0 -400.0 1600.0 .. 4400.0 4400.0 6400.0";
