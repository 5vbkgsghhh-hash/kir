...
Wall __el_SW1 = null;
ElementId __requestedType_SW1 = null;
ElementId __assignedType_SW1 = null;
...
using (Transaction __t = new Transaction(doc, "KIR: два пространства ОВК в венткамере"))
{
    try
    {
        ...
        int __operationPostStart_SW1 = __post.Count;
        // operation SW1
        {
            try { __requestedType_SW1 = __wt_SW1.Id;
                __assignedType_SW1 = __el_SW1.GetTypeId(); } catch { }
            if (__requestedType_SW1 == null || __requestedType_SW1 == ElementId.InvalidElementId
                || __assignedType_SW1 == null || __assignedType_SW1 == ElementId.InvalidElementId
                || !__assignedType_SW1.Equals(__requestedType_SW1))
                __post.Add("SW1: type assignment mismatch or unavailable (operation)");
        }
        if (__post.Count > __operationPostStart_SW1) { __t.RollBack(); return __Refuse("SW1", String.Join(" ; ", __post.Skip(__operationPostStart_SW1))); }
...
// witness SW1
{
    ...
    __rb["type_assignment"] = new Dictionary<string, object> {
        ...
        {"requested_type_id", __requestedType_SW1 == null ? null : __requestedType_SW1.ToString()},
        {"observed_type_id", __assignedType_SW1 == null ? null : __assignedType_SW1.ToString()} };
    __rb["type_id"] = null; __rb["type_id_status"] = "unavailable";
    __rb["type_id_reason"] = "type_id_unreadable";
    try { var __finalType = __el_SW1.GetTypeId();
