...
using (Transaction __t = new Transaction(doc, "KIR: проём в скатной кровле, рез перпендикулярно грани"))
{
    try
    {
        ...
        // post O1
        {
            ...
            {
                if (__ox0_O1 > 5000 + 50.0 || __ox1_O1 < 7000 - 50.0
                    || __oy0_O1 > 1000 + 50.0 || __oy1_O1 < 3000 - 50.0)
                    __post.Add("O1: opening extents do not cover the outline (geometry)");
            }
        }
        if (__post.Count > 0)
        {
