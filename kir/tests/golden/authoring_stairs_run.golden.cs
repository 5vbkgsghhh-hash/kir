...
Action<Autodesk.Revit.DB.Architecture.StairsRun, Autodesk.Revit.DB.Architecture.Stairs> __check_RN1 = (__run_RN1, __stairs_RN1) =>
{
    ...
    try
    {
        ...
        bool __relOk_RN1 = Math.Abs(__built_RN1 - __elevNorm_RN1) <= __dt_RN1;
        bool __absOk_RN1 = Math.Abs(__built_RN1 - (__sbz_RN1 + __elevNorm_RN1)) <= __dt_RN1;
        __frame_RN1 = __relOk_RN1 ? "relative" : (__absOk_RN1 ? "absolute" : "mismatch");
        if (!__relOk_RN1 && !__absOk_RN1)
            __post.Add("RN1: отметка низа марша не совпала с заявленной ни в относительной, ни в абсолютной рамке (geometry)");
    }
...
if (__freshRn_RN1 != null)
{
    ...
    __rb_RN1["base_elevation_frame"] = __frame_RN1;
