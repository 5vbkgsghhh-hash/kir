...
using (Transaction __t = new Transaction(doc, "KIR: плитный фундамент с двумя проёмами"))
{
    try
    {
        ...
        __hl_F1_0.Append(Line.CreateBound(P(5000, 3000, 0), P(7000, 3000, 0)));
        __hl_F1_0.Append(Line.CreateBound(P(7000, 3000, 0), P(7000, 5000, 0)));
        ...
        // post F1
        {
            ...
            else if (__slf_F1 != "0,0|0,8000|12000,0|12000,8000;5000,3000|5000,5000|7000,3000|7000,5000;9000,1000|9000,2000|10000,3000|11000,1000|11000,2000")
