...
using (Transaction __t = new Transaction(doc, "KIR: проём с закруглённой стороной в перекрытии, вертикальный рез"))
{
    try
    {
        ...
        __ca_O1.Append(Line.CreateBound(P(1000.0, 1000.0, __z_O1), P(3000.0, 1000.0, __z_O1)));
        __ca_O1.Append(Arc.Create(P(3000.0, 1000.0, __z_O1), P(3000.0, 3000.0, __z_O1), P(3400.0, 2000.0, __z_O1)));
        __ca_O1.Append(Line.CreateBound(P(3000.0, 3000.0, __z_O1), P(1000.0, 3000.0, __z_O1)));
        __ca_O1.Append(Line.CreateBound(P(1000.0, 3000.0, __z_O1), P(1000.0, 1000.0, __z_O1)));
        ...
        try { Parameter __cm = __el_O1.get_Parameter(BuiltInParameter.ALL_MODEL_INSTANCE_COMMENTS); if (__cm != null && !__cm.IsReadOnly) __cm.Set("kir:e9ed2032:O1"); } catch { }
        ...
        // post O1
        {
            ...
            if (__bc_O1 != null)
            {
                ...
                {
                    if (!__c_O1.IsBound) continue;
                    for (int __k_O1 = 0; __k_O1 <= 8; __k_O1++)
                    {
                        var __pt_O1 = __c_O1.Evaluate(__k_O1 / 8.0, true);
            ...
            {
                if (__ox0_O1 < 1000.0 - 50.0 || __ox0_O1 > 1000.0 + 50.0
                    || __ox1_O1 > 3400.0 + 50.0 || __ox1_O1 < 3000.0 - 50.0
                    || __oy0_O1 < 1000.0 - 50.0 || __oy0_O1 > 1000.0 + 50.0
                    || __oy1_O1 > 3000.0 + 50.0 || __oy1_O1 < 3000.0 - 50.0)
                    __post.Add("O1: opening extents leave the contour band (geometry)");
            }
        }
        if (__post.Count > 0)
        {
