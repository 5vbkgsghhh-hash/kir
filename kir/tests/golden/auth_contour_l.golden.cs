...
using (Transaction __t = new Transaction(doc, "KIR: Г-плита по контуру с проёмом"))
{
    try
    {
        ...
        __ol_F1.Append(Line.CreateBound(P(0.0, 0.0, 0), P(16000.0, 0.0, 0)));
        __ol_F1.Append(Line.CreateBound(P(16000.0, 0.0, 0), P(16000.0, 6000.0, 0)));
        __ol_F1.Append(Line.CreateBound(P(16000.0, 6000.0, 0), P(10000.0, 6000.0, 0)));
        __ol_F1.Append(Line.CreateBound(P(10000.0, 6000.0, 0), P(10000.0, 10000.0, 0)));
        __ol_F1.Append(Line.CreateBound(P(10000.0, 10000.0, 0), P(0.0, 10000.0, 0)));
        __ol_F1.Append(Line.CreateBound(P(0.0, 10000.0, 0), P(0.0, 0.0, 0)));
        __loops_F1.Add(__ol_F1);
        CurveLoop __hl_F1_0 = new CurveLoop();
        __hl_F1_0.Append(Line.CreateBound(P(1000.0, 1000.0, 0), P(4000.0, 1000.0, 0)));
        __hl_F1_0.Append(Line.CreateBound(P(4000.0, 1000.0, 0), P(4000.0, 7000.0, 0)));
        __hl_F1_0.Append(Line.CreateBound(P(4000.0, 7000.0, 0), P(1000.0, 7000.0, 0)));
        __hl_F1_0.Append(Line.CreateBound(P(1000.0, 7000.0, 0), P(1000.0, 1000.0, 0)));
        ...
        try { Parameter __cm = __el_F1.get_Parameter(BuiltInParameter.ALL_MODEL_INSTANCE_COMMENTS); if (__cm != null && !__cm.IsReadOnly) __cm.Set("kir:e904986a:F1"); } catch { }
        ...
        // post F1
        {
            ...
            if (__bb == null) __post.Add("F1: нет BoundingBox");
            else if (Math.Abs(MM(__bb.Min.X) - 0.0) > 50.0 || Math.Abs(MM(__bb.Max.X) - 16000.0) > 50.0 ||
                     Math.Abs(MM(__bb.Min.Y) - 0.0) > 50.0 || Math.Abs(MM(__bb.Max.Y) - 10000.0) > 50.0)
                __post.Add("F1: bbox extents mismatch (geometry): "
                    ...
                    + " против авторских [0.0 16000.0 | 0.0 10000.0] при допуске 50.0 мм");
            ...
            else if (__slf_F1 != "0,0|0,10000|10000,6000|10000,10000|16000,0|16000,6000;1000,1000|1000,7000|4000,1000|4000,7000")
                __post.Add("F1: sketch loops mismatch, expected 2 loop(s) (geometry)");
        }
        if (__post.Count > 0)
        {
