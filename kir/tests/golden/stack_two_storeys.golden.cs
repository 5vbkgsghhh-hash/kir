...
ElementId __requestedType_sec_L1_W = null;
ElementId __assignedType_sec_L1_W = null;
Wall __el_sec_L2_W = null;
ElementId __requestedType_sec_L2_W = null;
ElementId __assignedType_sec_L2_W = null;
using (Transaction __t = new Transaction(doc, "KIR: две типовых этажа со стеной"))
{
    try
    {
        ...
        int __operationPostStart_sec_L1_W = __post.Count;
        // operation sec_L1_W
        {
            try { __requestedType_sec_L1_W = __wt_sec_L1_W.Id;
                __assignedType_sec_L1_W = __el_sec_L1_W.GetTypeId(); } catch { }
            if (__requestedType_sec_L1_W == null || __requestedType_sec_L1_W == ElementId.InvalidElementId
                || __assignedType_sec_L1_W == null || __assignedType_sec_L1_W == ElementId.InvalidElementId
                || !__assignedType_sec_L1_W.Equals(__requestedType_sec_L1_W))
                __post.Add("sec_L1_W: type assignment mismatch or unavailable (operation)");
        }
        if (__post.Count > __operationPostStart_sec_L1_W) { __t.RollBack(); return __Refuse("sec_L1_W", String.Join(" ; ", __post.Skip(__operationPostStart_sec_L1_W))); }
        ...
        int __operationPostStart_sec_L2_W = __post.Count;
        // operation sec_L2_W
        {
            try { __requestedType_sec_L2_W = __wt_sec_L2_W.Id;
                __assignedType_sec_L2_W = __el_sec_L2_W.GetTypeId(); } catch { }
            if (__requestedType_sec_L2_W == null || __requestedType_sec_L2_W == ElementId.InvalidElementId
                || __assignedType_sec_L2_W == null || __assignedType_sec_L2_W == ElementId.InvalidElementId
                || !__assignedType_sec_L2_W.Equals(__requestedType_sec_L2_W))
                __post.Add("sec_L2_W: type assignment mismatch or unavailable (operation)");
        }
        if (__post.Count > __operationPostStart_sec_L2_W) { __t.RollBack(); return __Refuse("sec_L2_W", String.Join(" ; ", __post.Skip(__operationPostStart_sec_L2_W))); }
...
// witness sec_L1
{
    ...
    try { __rb["id"] = __el_sec_L1.Id.ToString(); } catch { __rb["id"] = null; }
    ...
    try
    {
        Element __kirIdentityEl = __el_sec_L1;
...
{
    var __rb = new Dictionary<string, object>();
    try { __rb["id"] = __el_sec_L2.Id.ToString(); } catch { __rb["id"] = null; }
    ...
    try
    {
        Element __kirIdentityEl = __el_sec_L2;
        if (__kirIdentityEl != null)
        {
            __rb["element_identity_reason"] = "identity_incomplete";
            var __kirIdentityId = __kirIdentityEl.Id;
...
{
    var __rb = new Dictionary<string, object>();
    try { __rb["id"] = __el_sec_L1_W.Id.ToString(); } catch { }
    __rb["element_identity"] = null;
    __rb["element_identity_status"] = "unavailable";
    __rb["element_identity_reason"] = "element_missing";
    try
    {
        Element __kirIdentityEl = __el_sec_L1_W;
        if (__kirIdentityEl != null)
        {
            __rb["element_identity_reason"] = "identity_incomplete";
            var __kirIdentityId = __kirIdentityEl.Id;
    ...
    __rb["type_assignment"] = new Dictionary<string, object> {
        ...
        {"requested_type_id", __requestedType_sec_L1_W == null ? null : __requestedType_sec_L1_W.ToString()},
        {"observed_type_id", __assignedType_sec_L1_W == null ? null : __assignedType_sec_L1_W.ToString()} };
    __rb["type_id"] = null; __rb["type_id_status"] = "unavailable";
    __rb["type_id_reason"] = "type_id_unreadable";
    try { var __finalType = __el_sec_L1_W.GetTypeId();
...
{
    var __rb = new Dictionary<string, object>();
    try { __rb["id"] = __el_sec_L2_W.Id.ToString(); } catch { }
    __rb["element_identity"] = null;
    __rb["element_identity_status"] = "unavailable";
    __rb["element_identity_reason"] = "element_missing";
    try
    {
        Element __kirIdentityEl = __el_sec_L2_W;
        if (__kirIdentityEl != null)
        {
            __rb["element_identity_reason"] = "identity_incomplete";
            var __kirIdentityId = __kirIdentityEl.Id;
    ...
    __rb["type_assignment"] = new Dictionary<string, object> {
        {"scope", "operation_end_before_commit"},
        {"requested_type_id", __requestedType_sec_L2_W == null ? null : __requestedType_sec_L2_W.ToString()},
        {"observed_type_id", __assignedType_sec_L2_W == null ? null : __assignedType_sec_L2_W.ToString()} };
    __rb["type_id"] = null; __rb["type_id_status"] = "unavailable";
    __rb["type_id_reason"] = "type_id_unreadable";
    try { var __finalType = __el_sec_L2_W.GetTypeId();
        if (__finalType != null && __finalType != ElementId.InvalidElementId) {
            __rb["type_id"] = __finalType.ToString(); __rb["type_id_status"] = "captured";
            __rb["type_id_reason"] = null;
        } else __rb["type_id_reason"] = "type_id_missing"; } catch { }
