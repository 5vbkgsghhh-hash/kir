...
using (Transaction __t = new Transaction(doc, "KIR: повёрнутый прямоугольный проём в скатной кровле, рез перпендикулярно грани"))
{
    try
    {
        ...
        __ca_O1.Append(Line.CreateBound(P(5000.0, 1000.0, __z_O1), P(6732.05, 2000.0, __z_O1)));
        __ca_O1.Append(Line.CreateBound(P(6732.05, 2000.0, __z_O1), P(5732.05, 3732.05, __z_O1)));
        __ca_O1.Append(Line.CreateBound(P(5732.05, 3732.05, __z_O1), P(4000.0, 2732.05, __z_O1)));
        __ca_O1.Append(Line.CreateBound(P(4000.0, 2732.05, __z_O1), P(5000.0, 1000.0, __z_O1)));
        ...
        try { Parameter __cm = __el_O1.get_Parameter(BuiltInParameter.ALL_MODEL_INSTANCE_COMMENTS); if (__cm != null && !__cm.IsReadOnly) __cm.Set("kir:5a065833:O1"); } catch { }
        ...
        // post O1
        {
            ...
            {
                if (__ox0_O1 > 4000.0 + 50.0 || __ox1_O1 < 6732.1 - 50.0
                    || __oy0_O1 > 1000.0 + 50.0 || __oy1_O1 < 3732.1 - 50.0)
                    __post.Add("O1: opening extents do not cover the contour (geometry)");
            }
        }
        if (__post.Count > 0)
        {
