...
var __c_pdf = new FilteredElementCollector(doc).OfClass(typeof(ImageInstance)).Cast<Element>()
    .Where(e => __ImageTypeOf(e) != null && __ImageTypeOf(e).Source != ImageTypeSource.Internal && __ImageTypeOf(e).Path != null && __ImageTypeOf(e).Path.EndsWith(".pdf", StringComparison.OrdinalIgnoreCase))
    .OrderBy(e => __IdOf(e))
    .ToList();
