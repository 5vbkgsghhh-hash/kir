    ...
    try
    {
        ...
        try {
            ...
            if (__se_TAG1 != null)
            {
                ...
                var __uv_TAG1 = new UV(U(3000.0), U(800.0));
                ...
                else if (__ar_TAG1 != null)
                {
                    ...
                    { __t.RollBack(); return __Refuse("TAG1", "цель — SpatialElement рода " + __ClassName(__se_TAG1) + ", а марки строятся только для помещения, площади и пространства"); }
            }
            else
            {
