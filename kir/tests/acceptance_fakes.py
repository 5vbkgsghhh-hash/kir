...
class PassingAcceptanceBridge:
    ...
    def _expectation(self):
        ...
        # Must match acceptance_runtime.prepare_acceptance byte for byte:
        # the expectation participates in the signature, and an extra or
        # missing directory immediately breaks strict census parsing.
