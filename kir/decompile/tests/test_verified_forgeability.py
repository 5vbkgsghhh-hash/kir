...
in a process that merely has the right to import it:
    ...
    import kir.decompile.verified as V
...
import kir.decompile.verified as verified_module  # noqa: E402
...
class SerializationCarriesNoTrustTests(unittest.TestCase):
    ...
    trust -- `from_dict` re-proves rather than believing a stored flag (R7)",
