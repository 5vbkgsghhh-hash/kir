...
from kir.decompile.merkle import build_index, merkle_hash  # noqa: E402
from kir.decompile.priors import (  # noqa: E402
    PriorModel,
    PriorSchemaError,
    UnknownShapeError,
    fit,
...
class ParameterPriors(unittest.TestCase):
    ...
    def test_pr5_median_is_robust_nearest_rank(self) -> None:
        ...
        from kir.decompile.priors import _nearest_rank
