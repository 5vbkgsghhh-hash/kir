...
from kir.decompile.component import (  # noqa: E402
    ComponentLibrary,
    build_library,
)
from kir.decompile.honesty import (  # noqa: E402
    EquivalenceClaim,
    EquivalenceScope,
    EquivalenceState,
)
from kir.decompile.merkle import build_index  # noqa: E402
from kir.decompile.rebuild import delta_between  # noqa: E402
from kir.decompile.journal import new_journal, commit_trees  # noqa: E402
from kir.decompile.merge3 import merge3_trees  # noqa: E402
from kir.decompile.verified import (  # noqa: E402
    ForgeryError,
    HonestyTypeError,
    Proof,
    ProofMismatchError,
...
class HonestPath(unittest.TestCase):
    ...
    def test_v3_broken_input_yields_no_proof(self) -> None:
        ...
        from kir.decompile.component import ComponentRoundTripError
